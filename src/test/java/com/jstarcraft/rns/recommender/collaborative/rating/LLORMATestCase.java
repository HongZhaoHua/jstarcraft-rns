...
import com.jstarcraft.rns.recommender.collaborative.rating.LLORMARecommender;
...
public class LLORMATestCase {
	...
	public void testRecommender() throws Exception {
		Configuration configuration = Configuration.valueOf("recommendation/collaborative/rating/llorma-test.properties");
