...
import com.jstarcraft.rns.model.collaborative.rating.ASVDPlusPlusRecommender;
import com.jstarcraft.rns.task.RatingTask;

public class ASVDPlusPlusRecommenderTestCase {

	@Test
	public void testRecommender() throws Exception {
	    Properties keyValues = new Properties();
        keyValues.load(this.getClass().getResourceAsStream("/data.properties"));
        keyValues.load(this.getClass().getResourceAsStream("/recommend/collaborative/rating/asvdpp-test.properties"));
