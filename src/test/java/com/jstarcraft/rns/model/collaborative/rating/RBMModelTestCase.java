...
public class RBMModelTestCase {
    ...
    public void testRecommender() throws Exception {
        ...
        Assert.assertEquals(0.73686945F, measures.getFloat(MAEEvaluator.class), 0F);
        Assert.assertEquals(0.9829577F, measures.getFloat(MPEEvaluator.class), 0F);
        Assert.assertEquals(0.8935981F, measures.getFloat(MSEEvaluator.class), 0F);
    }
