...
public class BiasedMFModelTestCase {
    ...
    public void testRecommender() throws Exception {
        ...
        Assert.assertEquals(0.6194245F, measures.getFloat(MAEEvaluator.class), 0F);
        Assert.assertEquals(0.982676F, measures.getFloat(MPEEvaluator.class), 0F);
        Assert.assertEquals(0.6448234F, measures.getFloat(MSEEvaluator.class), 0F);
    }
