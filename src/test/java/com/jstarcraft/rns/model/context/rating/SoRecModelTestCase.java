...
import com.jstarcraft.rns.model.context.rating.SoRecModel;
import com.jstarcraft.rns.task.RatingTask;

public class SoRecModelTestCase {
	...
	public void testRecommender() throws Exception {
		...
		Assert.assertThat(measures.get(MAEEvaluator.class.getSimpleName()), CoreMatchers.equalTo(0.63218623F));
		Assert.assertThat(measures.get(MPEEvaluator.class.getSimpleName()), CoreMatchers.equalTo(0.9905634F));
		Assert.assertThat(measures.get(MSEEvaluator.class.getSimpleName()), CoreMatchers.equalTo(0.65781707F));
	}
