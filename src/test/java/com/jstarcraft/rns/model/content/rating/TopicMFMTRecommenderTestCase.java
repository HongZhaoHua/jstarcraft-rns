...
import com.jstarcraft.rns.model.content.rating.TopicMFMTRecommender;
import com.jstarcraft.rns.task.RatingTask;

public class TopicMFMTRecommenderTestCase {

	@Test
	public void testRecommender() throws Exception {
	    Properties keyValues = new Properties();
        keyValues.load(this.getClass().getResourceAsStream("/data.properties"));
        keyValues.load(this.getClass().getResourceAsStream("/recommend/content/topicmfmt-test.properties"));
