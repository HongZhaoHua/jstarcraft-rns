...
import com.jstarcraft.rns.model.extend.ranking.PRankDRecommender;
import com.jstarcraft.rns.task.RankingTask;

public class PRankDRecommenderTestCase {

	@Test
	public void testRecommender() throws Exception {
	    Properties keyValues = new Properties();
        keyValues.load(this.getClass().getResourceAsStream("/data.properties"));
        keyValues.load(this.getClass().getResourceAsStream("/recommend/extend/prankd-test.properties"));
		...
		Assert.assertThat(measures.get(NoveltyEvaluator.class.getSimpleName()), CoreMatchers.equalTo(56.92662F));
